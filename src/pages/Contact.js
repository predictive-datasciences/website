...
const Contact = () => {
  ...
  return (
    <div className="contact page-sky-blue">
      {/* Header Section */}
      <section className="contact-header section bg-gradient-hero">
        <div className="container">
          <div
            id="contact-intro"
            data-animate
            className={`contact-intro text-center ${isVisible['contact-intro'] ? 'animate-fadeInUp' : ''}`}
          >
            <h3 className="page-title-white">{CONTENT.contact.hero.title}</h3>
            <p className="page-subtitle-white text-large mb-4">
        ...
        <div className="container">
          <div className="contact-layout">
            ...
            <div
              id="contact-form"
              data-animate
              className={`contact-form-section ${isVisible['contact-form'] ? 'animate-fadeInUp' : ''}`}
            >
            ...
            <div
              id="contact-info"
              data-animate
              className={`contact-info-section ${isVisible['contact-info'] ? 'animate-fadeInUp' : ''}`}
            >
              <div className="info-card">
                <h2>{CONTENT.contact.info.title}</h2>
                <p className="mb-6">{CONTENT.contact.info.description}</p>
                ...
                <div className="contact-methods">
                  ...
                  <div className="contact-method">
                    ...
                    <div className="method-info">
                      <h4>Phone</h4>
                      <a href={`tel:${COMPANY_INFO.phone}`} className="contact-link">
                        {COMPANY_INFO.phone}
                      </a>
                    </div>
                  </div>
      ...
      <section className="contact-cta section">
        <div className="container">
          <div className="cta-content text-center">
            ...
            <p className="text-large mb-8">{CONTENT.contact.cta.description}</p>
            <div className="cta-actions">
              <a
                href={`mailto:${COMPANY_INFO.email}?subject=Quick Consultation Request&body=Hi, I'd like to schedule a consultation to discuss how you can help transform my fintech business.`}
